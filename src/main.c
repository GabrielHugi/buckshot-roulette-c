...
// gcc src/main.c src/game/general.c src/game/handleItem.c src/gamemodes/gamemodes.c src/gamevars/vars.c src/interaction/messages.c src/game/handleGame.c src/tools/tools.c src/game/ai.c -o main 
int main() {
  prepareVariables();
  prepareGame();
  initiateGame();
